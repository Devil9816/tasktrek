                ...
                <div className="border border-emerald-200 rounded-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-emerald-800">Completed Tasks</span>
                      <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-emerald-200 text-emerald-800 text-xs font-bold">{completedFiltered.length}</span>
                    </div>
                    <svg
                      className={`w-4 h-4 text-emerald-600 transition-transform duration-200 ${showCompleted ? "rotate-180" : ""}`}
